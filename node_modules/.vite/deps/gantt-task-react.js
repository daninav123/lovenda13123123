...
var TaskListHeaderDefault = function TaskListHeaderDefault2(_ref) {
  ...
  }, " From"), import_react.default.createElement("div", {
    className: styles.ganttTable_HeaderSeparator,
    style: {
      height: headerHeight * 0.5,
...
var TaskListTableDefault = function TaskListTableDefault2(_ref) {
  ...
  return import_react.default.createElement("div", {
    ...
    }, " ", toLocaleDateString(t.start, dateTimeOptions)), import_react.default.createElement("div", {
      className: styles$1.taskListCell,
      style: {
        minWidth: rowWidth,
        maxWidth: rowWidth
...
var convertToBar = function convertToBar2(task, index, dates, columnWidth, rowHeight, taskHeight, barCornerRadius, handleWidth, rtl, barProgressColor, barProgressSelectedColor, barBackgroundColor, barBackgroundSelectedColor) {
  var x1;
  var x2;
  if (rtl) {
...
var convertToMilestone = function convertToMilestone2(task, index, dates, columnWidth, rowHeight, taskHeight, barCornerRadius, handleWidth, milestoneBackgroundColor, milestoneBackgroundSelectedColor) {
...
var Gantt = function Gantt2(_ref) {
  ...
  var _useState2 = (0, import_react.useState)(void 0), currentViewDate = _useState2[0], setCurrentViewDate = _useState2[1];
  ...
  var taskHeight = (0, import_react.useMemo)(function() {
...
//# sourceMappingURL=gantt-task-react.js.map
